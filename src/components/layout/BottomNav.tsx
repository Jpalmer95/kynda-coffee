...
import { Home, ShoppingBag, Coffee, User, Search } from "lucide-react";
          ...
          return (
            ...
            >
              <div className="relative">
                ...
                {isCart && itemCount > 0 && (
                  <span className="absolute -right-2.5 -top-1.5 flex h-4.5 w-4.5 items-center justify-center rounded-full bg-forest text-[10px] font-bold text-surface-deep ring-2 ring-sand">

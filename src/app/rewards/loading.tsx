    ...
    <section className="section-padding">
      <div className="container-max max-w-4xl animate-pulse">
        ...
        <div className="mt-12 sm:mt-16 grid gap-6 sm:grid-cols-3">
          {[1, 2, 3].map((i) => (
            <div key={i} className="rounded-2xl border border-latte/20 bg-card p-6 text-center space-y-3">
        ...
        <div className="mt-12 sm:mt-16 space-y-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="rounded-2xl border border-latte/20 bg-card p-5 sm:p-6">

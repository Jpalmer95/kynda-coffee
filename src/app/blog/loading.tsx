  ...
  return (
    <section className="section-padding">
      <div className="container-max max-w-4xl animate-pulse">
        ...
        <div className="mt-10 sm:mt-12 grid sm:grid-cols-2 rounded-2xl border border-latte/20 bg-card overflow-hidden">
        ...
        <div className="mt-10 sm:mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="rounded-2xl border border-latte/20 bg-card overflow-hidden">
              <div className="aspect-video bg-latte/20" />

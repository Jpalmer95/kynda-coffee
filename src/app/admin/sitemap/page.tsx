...
const GROUPS: RouteGroup[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { path: "/admin/designs/studio", label: "Design Studio", note: "custom merch designer (owner-only)" },
      { path: "/admin/command-center", label: "Command Center", note: "business mission control (Epic 13)" },
  ...
  },
  {
    ...
    routes: [
      ...
      { path: "/studio", label: "Design Studio (redirect)", note: "→ /admin/designs/studio (owner-only since 2026-08-06)" },
